...
class GomokuCPU {
    ...
    getMove(board, cpuColor) {
        console.log(`🤖 CPU思考開始 (難易度: ${this.difficulty})`);
    ...
    getEasyMove(board, cpuColor) {
        ...
        if (blockMove) {
            console.log('🛡️ 相手の勝利を阻止:', blockMove);
            return blockMove;
        }
        ...
        if (blockThreeMove) {
            console.log('🚫 相手の3連を阻止:', blockThreeMove);
    ...
    getHardMove(board, cpuColor) {
        ...
        if (bestMove.move) {
            console.log('🧠 ミニマックス最適手:', bestMove.move, 'スコア:', bestMove.score);
